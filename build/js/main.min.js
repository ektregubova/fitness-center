...
var videoButton = video.querySelector('[data-video-button]');
var videoPoster = video.querySelector('[data-video-poster]');
...
var subContent = document.querySelectorAll('[data-sub-tab]');
  ...
  subscrButtons.forEach(function (button) {
    button.addEventListener('click', function () {
      ...
      if (!button.classList.contains('is-active')) {
        ...
        subContent.forEach(function (el) {
