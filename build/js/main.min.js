...
/* harmony import */ var _modules_iframe__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/iframe */ "./js/modules/iframe.js");
/* harmony import */ var _modules_subscription__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/subscription */ "./js/modules/subscription.js");
/* harmony import */ var _modules_add_swiper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/add-swiper */ "./js/modules/add-swiper.js");
...
/* harmony import */ var _modules_anchor__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/anchor */ "./js/modules/anchor.js");
/* harmony import */ var _modules_coaches__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/coaches */ "./js/modules/coaches.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_coaches__WEBPACK_IMPORTED_MODULE_7__["breakpointChecker"])();
  Object(_modules_iframe__WEBPACK_IMPORTED_MODULE_2__["addIframe"])();
  Object(_modules_subscription__WEBPACK_IMPORTED_MODULE_3__["clickOnSubNav"])();
  Object(_modules_form_validation__WEBPACK_IMPORTED_MODULE_5__["validateForm"])();
  Object(_modules_add_swiper__WEBPACK_IMPORTED_MODULE_4__["removeSwiperClass"])();
  Object(_modules_add_swiper__WEBPACK_IMPORTED_MODULE_4__["addCoachSwiper"])();
  Object(_modules_add_swiper__WEBPACK_IMPORTED_MODULE_4__["addReviewsSwiper"])();
  Object(_modules_anchor__WEBPACK_IMPORTED_MODULE_6__["onLinkMove"])();
  Object(_modules_coaches__WEBPACK_IMPORTED_MODULE_7__["addClickChangeBreakpoint"])();
...
/*!**********************************!*\
  !*** ./js/modules/add-swiper.js ***!
  \**********************************/
/*! exports provided: addCoachSwiper, addReviewsSwiper, removeSwiperClass */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addCoachSwiper", function() { return addCoachSwiper; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addReviewsSwiper", function() { return addReviewsSwiper; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "removeSwiperClass", function() { return removeSwiperClass; });
...
var coachSwiper = document.querySelector('.coaches__swiper');
var reviewsSwiper = document.querySelector('.reviews__swiper');
var swiperButtons = document.querySelectorAll('[data-swiper-button]');
var swiperWrappers = document.querySelectorAll('[data-swiper]');
var removeSwiperClass = function removeSwiperClass() {
  ...
  swiperWrappers.forEach(function (elem) {
...
var addReviewsSwiper = function addReviewsSwiper() {
  ...
  var swiper = new _vendor_swiper_bundle_min__WEBPACK_IMPORTED_MODULE_0___default.a(reviewsSwiper, {
    navigation: {
...
var addCoachSwiper = function addCoachSwiper() {
  if (!coachSwiper) {
    return;
  }
  var swiper = new _vendor_swiper_bundle_min__WEBPACK_IMPORTED_MODULE_0___default.a(coachSwiper, {
    navigation: {
...
var anchor = document.querySelector('a[data-anchor]');
var onLinkMove = function onLinkMove() {
  if (!anchor) {
    return;
  }
...
/*!*******************************!*\
  !*** ./js/modules/coaches.js ***!
  \*******************************/
/*! exports provided: breakpointChecker, addClickChangeBreakpoint */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "breakpointChecker", function() { return breakpointChecker; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addClickChangeBreakpoint", function() { return addClickChangeBreakpoint; });
var coachesSlides = document.querySelectorAll('[data-coach]');
var breakpoint = window.matchMedia('(max-width:1199px)');
var coachesWrapper = document.querySelector('.coaches__wrapper[data-swiper]');
var toggleClassOnSlide = function toggleClassOnSlide(targetSlide) {
  if (!targetSlide.classList.contains('is-open')) {
    coachesSlides.forEach(function (elem) {
      elem.classList.remove('is-open');
    });
  }
  targetSlide.classList.toggle('is-open');
};
var addClickOnSlide = function addClickOnSlide(evt) {
  var targetSlide = evt.target.closest('[data-coach]');
  if (targetSlide) {
    toggleClassOnSlide(targetSlide);
  }
};
var clickOnCoachesSlides = function clickOnCoachesSlides() {
  if (!coachesWrapper) {
    return;
  }
...
var addClickChangeBreakpoint = function addClickChangeBreakpoint() {
...
var checkEmptyInputs = function checkEmptyInputs() {
  if (!formArray) {
    return;
  }
...
var inputCheck = function inputCheck(elem) {
...
var buttonHandler = function buttonHandler(evt) {
  checkEmptyInputs();
  var allValid = [];
...
var videoPoster = video ? video.querySelector('[data-video-poster]') : null;
if (videoButton) {
...
/*!************************************!*\
  !*** ./js/modules/subscription.js ***!
  \************************************/
/*! exports provided: clickOnSubNav */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "clickOnSubNav", function() { return clickOnSubNav; });
var subscrButtons = document.querySelectorAll('[data-sub-button]');
var subContents = document.querySelectorAll('[data-sub-tab]');
var subNavigation = document.querySelector('[data-sub-nav]');
subContents.forEach(function (elem) {
  elem.classList.remove('is-nojs');
});
subscrButtons.forEach(function (elem) {
  elem.classList.remove('is-nojs');
});
var clickOnSubNav = function clickOnSubNav() {
  if (!subNavigation) {
    return;
  }
...
var addClassOnButton = function addClassOnButton(targetButton) {
  var currentId = targetButton.getAttribute('data-but');
  ...
  if (!targetButton.classList.contains('is-active')) {
    ...
    subContents.forEach(function (el) {
